...
matplotlib.use('Agg')
epoch = 80
attention_node_path = '/home/weihsin/projects/MotionExpert/STAGCN_output_finetune/att_node_results_epoch' + \
    str(epoch) + '.json'
attention_matrix_path = '/home/weihsin/projects/MotionExpert/STAGCN_output_finetune/att_A_results_epoch' + \
    str(epoch) + '.json'
...
def draw(joints, video_path, output_path, file_name):
    ...
    while True:
        ...
        for attention_id in [0, 2, 3]:
            ...
            x_coordinates, y_coordinates = joints[frame_index][:,
                                                               0], joints[frame_index][:, 1]
    ...
    output[0].save(output_path, save_all=True,
                   append_images=output[1:], loop=0, disposal=2)
    cap.release()
