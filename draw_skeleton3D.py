...
import random, os, json, matplotlib
...
def draw(joints,num_frame,root):
    ...
    def animate(frame):
        ...
        skeleton_body_part = [[[15,12],[12,9],[9,6],[6,3],[3,0]], # skeleton_bone
                             [[0,1],[1,4],[4,7],[7,10]], # skeleton_left_leg
                             [[0,2],[2,5],[5,8],[8,11]], # skeleton_right_leg
                             [[9,13],[13,16],[16,18],[18,20]] # skeleton_left_hand
        ...
        for part in skeleton_body_part : 
            for index in part : 
                ...
                ax.plot([joints[frame][first][0], joints[frame][second][0]], [joints[frame][first][1], joints[frame][second][1]],[joints[frame][first][2], joints[frame][second][2]] ,color[count])
            count+=1
